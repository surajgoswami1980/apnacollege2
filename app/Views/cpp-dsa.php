...
<!-- first page sigma -->
<div class="container-fluid py-5 mt-5" style="background: white; height:80%">
  <div class="container" >
  <div class="row d-flex justify-content-between">
    <div class="mt-5 col-lg-6">
          <div class="container  mt-5 ">
          <h3 class="lh-base mb-3" style="font-size:30px; font-weight:600;"><span class="text-primary">Learn C++ </span> <span>Learn C++ with Data Structures & Algorithms in 4 Months!</span></h3><br>
          ...
          <div class="div  lh-sm d-flex align-items-center "><i class="fa-solid fa-video  align-items-center fa-xl text-center"></i>&nbsp;&nbsp;&nbsp;&nbsp;<h5 class="lh-sm text-center" >
                 ...
                 <button  type="button" class="btn  btn-primary p-2 px-5 py-2" style="font-size:20px; font-weight:600;  background-color:#ff7700; " > Enroll now ></button>
          </div>
    </div>
      <div  class=" col-lg-4 d-flex justify-content-center align-items-center" >
            <img style="height:65%;" src=" <?= base_url("images/cpp.png") ?>" >
          </div>
  </div>
  </div>
</div>
